...
cr=db.cursor()
cr.execute('''create table Admin(Name varchar(32), Email varchar(32), Password varchar(32))''')
cr.execute('''create table courses(courseid int, coursename varchar(32))''')
cr.execute('''create table teacher(Tid int, name varchar(32), email varchar(32), gender varchar(32), courseassigned varchar(32))''')
