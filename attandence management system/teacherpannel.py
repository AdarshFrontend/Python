...
class Teacher:
    ...
    def attendance(self):
        ...
        if len(data)==0:
            for i in range(len(self.check_values)):
                cr.execute(f'''insert into attendance values({self.labels_roll[i]['text']},'{self.course}','{today_str}','{self.check_values[i].get()}')''')
                db.commit()
    ...
    def getstudents(self):
        ...
        for i in range(len(data1)):
            ...
            self.check_values.append(StringVar())
    ...
    def updateprofile(self):
        db = sqlite3.connect("attendancesystem.db")
        cr = db.cursor()  
        cr.execute(f'''update teacher set name='{self.teachername.get()}',
    ...
    def view(self):
        ...
        L1=Label(self.f33,text="id" ,font=("Elephant", 11),bg='#E5E4E2',bd=3,  highlightthickness=2, highlightbackground='red')
        ...
        L2=Label(self.f33,text="name" ,font=("Elephant", 11),bg='#E5E4E2',bd=3,  highlightthickness=2, highlightbackground='red')
        L2.grid(row=1,column=0  ,padx=10,pady=10)
        self.teachername=Entry(self.f33,textvariable=list_data[1])
        self.teachername.grid(row=1,column=1,padx=10,pady=10)
        
        
        L3=Label(self.f33,text="email" ,font=("Elephant", 11),bg='#E5E4E2',bd=3,  highlightthickness=2, highlightbackground='red')
        ...
        L4=Label(self.f33,text="pass" ,font=("Elephant", 11),bg='#E5E4E2',bd=3,  highlightthickness=2, highlightbackground='red')
        L4.grid(row=3,column=0,padx=10,pady=10)
        self.teacherpass=Entry(self.f33,textvariable=list_data[3])
        self.teacherpass.grid(row=3,column=1,padx=10,pady=10)
    
        
        L6=Label(self.f33,text="Assign course" ,font=("Elephant", 11),bg='#E5E4E2',bd=3,  highlightthickness=2, highlightbackground='red')
        ...
        addteacher=Button(self.f33,text="Update Profile",font=("Arial bold", 10),command=self.updateprofile)
        addteacher.grid(row=5,column=1,padx=10,pady=10)
        
        log=Button(self.f33,text="Log out",font=("Arial bold", 10),command=self.logout)
        log.grid(row=6,column=1,padx=10,pady=10)
